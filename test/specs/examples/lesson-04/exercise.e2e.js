...
describe('Login Page', async () => {
  ...
  it('should show login form', async () => {
    ...
    console.log(
      'Password field is dislayed: ' + (await passwordField.isDisplayed())
    );
    console.log(
      'Password field is dislayed: ' + (await passwordField.isEnabled())
    );

    const loginButton = $('.btn-primary');
    console.log(
      'Login button is dislayed: ' + (await loginButton.isDisplayed())
    );
  ...
  it('should login with valid credentials', async () => {
    ...
    console.log(
      'User currently logged in: ' + (await userNameDropdown.getText())
    );
  });
